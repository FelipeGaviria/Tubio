...
const verticalPieces: BrandPiece[] = [
  { brand: "Burro Pizzería", src: "/images/portfolio/marcas/burro1.png", alt: "El Burro, pieza 1" }, { brand: "Burro Pizzería", src: "/images/portfolio/marcas/burro2.png", alt: "El Burro, pieza 2" }, { brand: "Burro Pizzería", src: "/images/portfolio/marcas/burro3.png", alt: "El Burro, pieza 3" }, { brand: "Burro Pizzería", src: "/images/portfolio/marcas/burro4.png", alt: "El Burro, pieza 4" },
...
export default function BrandCarousel() {
  ...
  useEffect(() => { const timer = window.setInterval(() => { const element = track.current; if (!element) return; const next = Math.max(element.clientWidth * .78, 320); if (element.scrollLeft + element.clientWidth >= element.scrollWidth - 12) element.scrollTo({ left: 0, behavior: "smooth" }); else element.scrollBy({ left: next, behavior: "smooth" }); }, 5000); return () => window.clearInterval(timer); }, []);
