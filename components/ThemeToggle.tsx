...
export function ThemeToggle() {
  ...
  const [wipe, setWipe] = useState<"night" | "day" | null>(null);
  ...
  return <>
    {wipe ? createPortal(<span className={`tubio-theme-wipe is-${wipe}`} aria-hidden="true" />, document.body) : null}
