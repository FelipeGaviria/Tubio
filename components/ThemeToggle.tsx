...
export function ThemeToggle() {
  ...
  return <button className="home-theme-toggle" type="button" onClick={toggle} aria-pressed={night} aria-label={night ? "Activar modo claro" : "Activar modo nocturno"} title={night ? "Modo claro" : "Modo nocturno"}>
