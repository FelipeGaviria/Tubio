...
export function AttendanceApp() {
  ...
  function setMemberFirstSession(id: string, checked: boolean) { if (!unlocked || !canEditFirstSession(id, data?.sessions ?? [])) return; setData((d) => d && ({ ...d, members: d.members.map((m) => m.id === id ? { ...m, firstSessionAt: checked ? m.joined : undefined } : m) })); }
  ...
  return <main data-club="toastmasters" className={`attendance-page ${unlocked ? "is-editing" : "is-viewing"}`}>
