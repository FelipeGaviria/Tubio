...
export default function PortfolioPage() {
  return (
    <main className="raw-portfolio">
      ...
      <section className="raw-portfolio-hero"><div className="raw-hero-top"><div><p className="raw-date">25 Jul, 2026</p><p className="raw-person">Felipe Gaviria Vásquez</p></div><p className="raw-role">Estrategia de marca&nbsp;&nbsp; / &nbsp;&nbsp;Dirección creativa&nbsp;&nbsp; / &nbsp;&nbsp;Producción audiovisual</p><p className="raw-contact-data">hola@tubio.co<br />Colombia</p></div><div className="raw-hero-title"><p className="raw-label">Creative presentation</p><h1>Portfolio</h1><p>Una selección de ideas, imágenes, estrategias y formas de hacer que las marcas encuentren su lugar.</p></div><a className="raw-scroll-cue" href="#sobre-mi">Desplazar para explorar <b>↓</b></a></section>
