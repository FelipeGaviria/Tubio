...
const WhatsAppOutlineIcon = () => <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.5 11.5a8.5 8.5 0 0 1-12.6 7.4L3 20.5l1.6-4.7a8.5 8.5 0 1 1 15.9-4.3Z"/><path d="M8.2 7.8h1.9l1 3-1.2 1.2a9.5 9.5 0 0 0 4.1 4.1l1.2-1.2 3 1v1.9c0 .8-.7 1.5-1.5 1.4A13.2 13.2 0 0 1 4.8 7.3c-.1-.8.6-1.5 1.4-1.5" transform="translate(2 2) scale(.78)"/></svg>;
...
export default function TemplateFourPage() {
  ...
  return <main id="inicio" className={`template-four-shell${lightMode ? " is-light" : ""}`} style={{ "--scroll": `${scrollY}px` } as CSSProperties}>
    ...
    <section className="template-four-hero">
      <div className="template-four-portrait" style={{ transform: `translate3d(-50%, ${scrollY * -.018}px, 0) scale(${1 + scrollY * .000015})` }}><div className="template-four-photo-halo"/><Image className="template-four-photo-night" src="/images/landings/tona-3.png" alt="Retrato de Mariantonia Sepúlveda" fill priority quality={100} sizes="(max-width: 700px) 100vw, 900px" /><Image className="template-four-photo-light" src="/images/landings/tona-4.png" alt="Retrato de Mariantonia Sepúlveda" fill priority quality={100} sizes="(max-width: 700px) 100vw, 900px" /></div>
      <div className="template-four-hero-fade" />
      <div className="template-four-identity"><p className="template-four-kicker">Negociadora internacional</p><h1><span>Mariantonia</span><em>Sepúlveda G.</em></h1>
        <div className="template-four-profile-glass">
          <nav className="template-four-socials" aria-label="Contacto y redes sociales"><a href="https://instagram.com" target="_blank" rel="noreferrer" aria-label="Instagram"><InstagramIcon /></a><a href="mailto:hola@tubio.co" aria-label="Correo electrónico"><MailIcon /></a><a href="https://wa.me/" target="_blank" rel="noreferrer" aria-label="WhatsApp"><WhatsAppOutlineIcon /></a></nav>
