...
export default function TemplateFourPage() {
  ...
  return <main className="template-four-shell">
    ...
    <header className="template-four-header"><Link href="/landings">TuBio / Template 4</Link><span>Parallax biolink</span></header>
    ...
    <section className="template-four-note"><p>"La mejor tarjeta digital no solo informa. Deja una sensación."</p><span>— Andrea</span></section>
    <footer className="template-four-footer"><span>Template 4 / biolink parallax</span><Link href="/landings">Ver landings</Link></footer>
  </main>;
}