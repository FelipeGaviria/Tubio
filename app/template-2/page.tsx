...
export const metadata: Metadata = {
  ...
  keywords: ['tarjeta digital', 'tarjeta de presentaci�n digital', 'landing profesional', 'TuBio', 'contacto digital'],
  openGraph: {
    title: 'Tarjeta digital profesional | TuBio',
    description: 'Comparte tu informaci�n profesional, redes y contacto desde una experiencia digital elegante.',
    type: 'website',
    locale: 'es_CO',
  },
  twitter: {
    card: 'summary',
    title: 'Tarjeta digital profesional | TuBio',
    description: 'Comparte tu informaci�n profesional desde un solo enlace.',
  },
};
