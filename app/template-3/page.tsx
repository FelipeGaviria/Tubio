...
export default function TemplateThreePage() {
  return (
    <main className="template-three-shell">
      <header className="template-three-header"><Link href="/portafolio">TuBio / Template 3</Link><span>Editorial landing / 2026</span></header>
      ...
      <footer id="contacto" className="template-three-footer"><span>Template 3 / narrativa editorial</span><Link href="/portafolio">Ver todas las landings</Link></footer>
    </main>
  );
}