...
export default function TemplateThreePage() {
  return (
    <main className="template-three-shell">
      <header className="template-three-header"><Link href="/">TuBio / Template 3</Link><span>Editorial landing / 2026</span></header>
      ...
      <section className="template-three-quote"><p>&ldquo;Tu marca no necesita gritar para quedarse en la memoria.&rdquo;</p><a className="template-three-button template-three-button-dark" href="#contacto">Quiero construir la mia <span>→</span></a></section>
      <footer id="contacto" className="template-three-footer"><span>Template 3 / narrativa editorial</span><Link href="/">Ver todas las landings</Link></footer>
    </main>
  );
}
